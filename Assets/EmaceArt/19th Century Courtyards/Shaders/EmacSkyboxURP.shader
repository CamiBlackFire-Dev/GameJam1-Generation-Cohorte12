    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings IN) : SV_Target
            {
                ...
                {
                    float  ang   = (float)_SkyGradAngle * 0.01745329252;
                    ...
                    // Linear ramp 0..1 across the full sky — visible everywhere
                    half   tAz  = saturate((half)(azDot * 0.5 + 0.5));
                    // Spread sharpens the falloff edge (1=soft full-sky, 0.1=hard half-sphere)
